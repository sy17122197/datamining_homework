...
def main():
    ...
    # Do training.
    loss, precision, recall, f1, acc = test_textcnn_model(model,  test_data, criterion, config)
    print("Test Set loss: {0:.2f},  precision: {1:.2f},  recall:{2:.2f},  f1:{3:.2f}, acc:{4:.2f}".format(
